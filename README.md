...
I am working on getting the package added to CRAN. In the meantime, you can use the package by downloading the package file 'RHigh_0.0.0.9000.tar.gz' and then directly installing and loading it in R. Here are the steps broken down.
